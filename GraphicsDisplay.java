...
public class GraphicsDisplay extends JPanel {
  ...
  public GraphicsDisplay() {
    ...
    /*
     * graphicsStroke = new BasicStroke(1.0f, BasicStroke.CAP_BUTT,
     * BasicStroke.JOIN_ROUND, 10.0f, new float [] {4,1,1,1,2,1,1,1,4}, 0.0f);
     */
  ...
  protected void paintGrid(Graphics2D canvas) {
    ...
    canvas
        .draw(new Line2D.Double(xyToPoint(viewport[1][0], viewport[0][1]), xyToPoint(viewport[1][0], viewport[1][1])));
    ...
    canvas
        .draw(new Line2D.Double(xyToPoint(viewport[0][0], viewport[0][1]), xyToPoint(viewport[1][0], viewport[0][1])));
  }
  ...
  protected void paintAxis(Graphics2D canvas) {
    ...
    if (!(viewport[1][1] > 0.0D || viewport[0][1] < 0.0D)) {
      ...
      canvas.draw(new Line2D.Double(
          xyToPoint(viewport[1][0] - (viewport[1][0] - viewport[0][0]) * 0, (viewport[0][1] - viewport[1][1]) * 0.005),
  ...
  protected void paintComponent(Graphics g) {
    ...
    if (clockRotate) {
      AffineTransform at = AffineTransform.getRotateInstance(Math.PI / 2, getSize().getWidth() / 2,
          getSize().getHeight() / 2);
      at.concatenate(new AffineTransform(getSize().getHeight() / getSize().getWidth(), 0.0, 0.0,
          getSize().getWidth() / getSize().getHeight(), (getSize().getWidth() - getSize().getHeight()) / 2,
